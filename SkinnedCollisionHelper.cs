using UnityEngine;
 ...
 public class SkinnedCollisionHelper : MonoBehaviour
 {
     ...
     [SerializeField] private initializeOnAwake;
    ...
    /// <summary>
    /// Function: Initializes bounds, mesh and collider first.
    /// </summary>
     public void Initialize()
     {
         ...
         {
             Debug.LogError(gameObject.name + ": SkinnedCollisionHelper: object either has no SkinnedMeshRenderer or has no MeshCollider!");
         }
     }
    ...
    /// <summary>
    /// Function: UpdateCollisionMesh Manually recalculates the collision mesh of the skinned mesh on  object.
    /// </summary>
